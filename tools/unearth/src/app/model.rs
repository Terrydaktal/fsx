...
pub(crate) struct Options {
    ...
    /// Force a live filesystem traversal. This suppresses all index access,
    /// including the implicit watcher-backed path used by full-path searches.
    pub(crate) live_only: bool,
    ...
    pub(crate) watch_status_json: bool,
    pub(crate) watch_metrics: Option<String>,
    pub(crate) watch_metrics_os: Option<OsString>,
    pub(crate) watch_metrics_ttl: u64,
    pub(crate) watch_metrics_max_bytes: u64,
    pub(crate) absolute_paths: bool,
    pub(crate) lossless_paths: bool,
